...
# Set this to true to use json instead of bin files for data/layouts/*/border.bin and data/layouts/*/map.bin.
# 	The bin versions will still be used, but will get regenerated by the json files.
#	Use `run-layout-mapgrids-bin-to-json` to help migrate to this option.
OPTION_LAYOUT_MAPGRIDS_USE_JSON := false
# Set this to true to use json instead of bin files for data/tilesets/*/*/metatiles.bin and data/tilesets/*/*/metatile_attributes.bin.
# 	The bin versions will still be used, but will get regenerated by the json files.
#	Use `run-tileset-metatiles-bin-to-json` to help migrate to this option.
OPTION_TILESET_METATILES_USE_JSON := false
